...
test_3 <- matrix(
  rtruncnorm(10000 * 1000, a = -2, b = 2, mean = 0, sd = 1), 
  nrow = 10000, 
  ncol = 1000
)
hist(test_3)
...
write.csv(coefficients_3, 
          file = "1_Coefficients_Species_Uncertainty/coefficients_3.csv", 
          row.names = FALSE)
head(coefficients_3)
# Specifies the full path to save the file

write.csv(PseudoData3, 
          file = "1_Coefficients_Species_Uncertainty/FagusG.csv", 
          row.names = FALSE)
