...
test_5 <- matrix(
  rtruncnorm(10000 * 1000, a = -1.5, b = 1.5, mean = 0, sd = 1), 
  nrow = 10000, 
  ncol = 1000
)
hist(test_5)
...
write.csv(coefficients_5, 
          file = "1_Coefficients_Species_Uncertainty/coefficients_5.csv", 
          row.names = FALSE)

# Specifies the full path to save the file

write.csv(PseudoData_5, 
          file = "1_Coefficients_Species_Uncertainty/HacerRu.csv", 
          row.names = FALSE)
