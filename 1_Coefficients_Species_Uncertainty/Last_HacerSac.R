...
test_1 <- matrix(
  rtruncnorm(10000 * 1000, a = -3, b = 3, mean = 0, sd = 1), 
  nrow = 10000, 
  ncol = 1000
)
hist(test_1)
...
write.csv(coefficients_1, 
          file = "1_Coefficients_Species_Uncertainty/coefficients_1.csv", 
          row.names = FALSE)


write.csv(PseudoData1, 
          file = "1_Coefficients_Species_Uncertainty/HacerSa", 
          row.names = FALSE)



#hist(coefficients9_1$a)
coefficients_1<-read.csv("1_Coefficients_Species_Uncertainty/coefficients_1")
#head(coefficients_1)
#
...
PseudoData1<-read.csv("1_Coefficients_Species_Uncertainty/HacerSa")
